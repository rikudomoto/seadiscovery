...
ActiveRecord::Schema.define(version: 2020_12_09_101758) do
  ...
  create_table "seas", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "user_id"
